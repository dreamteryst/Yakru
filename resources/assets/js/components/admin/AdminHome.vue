					...
					<div class="panel-body bg-silver">
						<div class="chats" data-scrollbar="true" data-height="225px">
							<div class="left">
								...
								<a href="javascript:;" class="image"><img alt="" src="/assets_admin/img/user/user-12.jpg" /></a>
								<div class="message">
							...
							<div class="right">
								...
								<a href="javascript:;" class="image"><img alt="" src="/assets_admin/img/user/user-13.jpg" /></a>
								<div class="message">
							...
							<div class="left">
								...
								<a href="javascript:;" class="image"><img alt="" src="/assets_admin/img/user/user-10.jpg" /></a>
								<div class="message">
							...
							<div class="left">
								...
								<a href="javascript:;" class="image"><img alt="" src="/assets_admin/img/user/user-14.jpg" /></a>
								<div class="message">
			...
			<div class="col-lg-4">
				...
				<div class="panel panel-inverse" data-sortable-id="index-4">
					...
					<ul class="registered-users-list clearfix">
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-5.jpg" alt="" /></a>
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-3.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Ancient Caviar
								<small>Korean</small>
							</h4>
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-1.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Marble Lungs
								<small>Indian</small>
							</h4>
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-8.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Blank Bloke
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-2.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Hip Sculling
								<small>Cuban</small>
							</h4>
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-6.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Flat Moon
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-4.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Packed Puffs
						...
						<li>
							<a href="javascript:;"><img src="/assets_admin/img/user/user-9.jpg" alt="" /></a>
							<h4 class="username text-ellipsis">
								Clay Hike
								<small>Swedish</small>
							</h4>
