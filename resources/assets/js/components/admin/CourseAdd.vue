        ...
        <form @submit="save">
          ...
          <div class="form-group">
            ...
            <input
              type="file"
              class="form-control"
              :class="{'is-invalid':isError('course_picture')}"
              id="course_picture"
            ...
            <div
              ...
              v-if="isError('course_picture')"
            >{{ errors.course_picture[0] }}</div>
          </div>
          <div class="form-group">
            ...
            <input
              type="text"
              class="form-control"
              :class="{'is-invalid':isError('course_video')}"
              id="course_video"
              v-model="course_video"
              placeholder="Course Video"
            >
            <div
              class="invalid-feedback"
              v-if="isError('course_video')"
            >{{ errors.course_video[0] }}</div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div
              class="invalid-feedback"
              v-if="isError('refund_policy')"
            >{{ errors.refund_policy[0] }}</div>
          </div>
          <div class="form-group">
            ...
            <div
              class="invalid-feedback"
              v-if="isError('course_price')"
            >{{ errors.course_price[0] }}</div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model="course_limit"
              placeholder="Course Price"
            >
            <div
              class="invalid-feedback"
              v-if="isError('course_limit')"
            >{{ errors.course_limit[0] }}</div>
          </div>
...
export default {
    ...
    methods: {
        save(e) {
            ...
            formData.append("refund_policy", this.refund_policy);
            formData.append("refund_percentage", this.refund_percentage);

            axios
                .post(`/admin/api/course`, formData)
                .then(response => {
