<template>
    <section>
        ...
        <ol class="breadcrumb pull-right">
            ...
            <li class="breadcrumb-item active">จัดการข้อมูลผู้สอน</li>
        </ol>
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">จัดการข้อมูลผู้สอน <small></small></h1>
        <!-- end page-header -->
        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">รายชื่อผู้สอน</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
...
export default {
    ...
    mounted() {
        var self = this;
        $(function () {
            self.table = $("#teacher-table").DataTable({
                responsive: true,
                autoWidth: false,
                processing: true,
                serverSide: true,
                ajax: `/admin/api/teacher/data`,
                order: [[0, "desc"]],
                ...
                drawCallback: function (settings) {
                    $(".view-course").on("click", function () {
                        ...
                        self.data = JSON.parse(
                            unescape($(this).attr("data-teacher"))
                        );
